...
rekt = Image.open('rekt.jpg').resize(size)
user_photo = Image.open('user.jpg').convert('RGB').resize(size)
...
writeGif('newrekt.gif', results, duration=0.11, repeat=True, dither=False, nq=0, subRectangles=False)    
